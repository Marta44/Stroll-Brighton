...
8. [Owl Carousel](https://owlcarousel2.github.io/OwlCarousel2/) : was used to display my suggestions in the "Tips" section and to display the data called from Google Map API.
